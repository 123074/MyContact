...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void addContact(Contact contact) {
        ...
        //inserting row
        if (db.insert(TABLE_CONTACT, null, values) != -1) {
    ...
    public Contact getContact(int id) {
        ...
        Cursor cursor = db.query(TABLE_CONTACT,
                new String[]{KEY_ID, KEY_NAME, KEY_PHONE, KEY_EMAIL},
                KEY_ID + "=?",
...
//                new String[]{String.valueOf(contact.get_id())});
        int update = db.update(TABLE_CONTACT, values, KEY_ID + " = ?",
                new String[]{String.valueOf(contact.get_id())});
        if(update != -1){
    ...
    public void deleteContact(Contact contact) {
        SQLiteDatabase db = this.getWritableDatabase();
        int del = db.delete(TABLE_CONTACT, KEY_ID + " = ?",new String[]{String.valueOf(contact.get_id())});
